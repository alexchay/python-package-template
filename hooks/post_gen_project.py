...
REMOVE_PATHS = [
    ...
    "{% if not cookiecutter.dependency_management == 'poetry' %} poetry.toml {% endif %}",
    "{% if cookiecutter.dependency_management == 'poetry' %} MANIFEST.in {% endif %}",
    ...
    "{% if cookiecutter.use_gotask and not cookiecutter.dependency_management == 'poetry' %} taskfiles/poetry.yml {% endif %}",
